defmodule CrucibleDeployment.Targets.Ollama do
  @moduledoc """
  Ollama target adapter for local model serving.
  """
  ...
  @doc """
  Terminate an Ollama deployment.
  """
  @impl true
  ...
  @doc """
  Check health for an Ollama deployment.
  """
  @impl true
  ...
  @doc """
  Fetch metrics for an Ollama deployment.
  """
  @impl true
  ...
  @doc """
  Set traffic weight for an Ollama deployment.
  """
  @impl true
