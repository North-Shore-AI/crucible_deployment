defmodule CrucibleDeployment.Targets.Kubernetes do
  @moduledoc """
  Generic Kubernetes deployment target adapter.
  """
  ...
  @doc """
  Terminate a Kubernetes deployment.
  """
  @impl true
  ...
  @doc """
  Check health for a Kubernetes deployment.
  """
  @impl true
  ...
  @doc """
  Fetch metrics for a Kubernetes deployment.
  """
  @impl true
  @spec get_metrics(String.t()) :: {:ok, map()} | {:error, term()}
  def get_metrics(_deployment_id), do: {:ok, %{requests: 0, pods_ready: 0}}

  @doc """
  Set traffic weight for a Kubernetes deployment.
  """
  @impl true
