defmodule CrucibleDeployment.Targets.HuggingFace do
  @moduledoc """
  Hugging Face Inference Endpoint target adapter.
  """
  ...
  @doc """
  Update a Hugging Face deployment.
  """
  @impl true
  ...
  @doc """
  Terminate a Hugging Face deployment.
  """
  @impl true
  ...
  @doc """
  Check health for a Hugging Face deployment.
  """
  @impl true
  ...
  @doc """
  Fetch metrics for a Hugging Face deployment.
  """
  @impl true
  ...
  @doc """
  Set traffic weight for a Hugging Face deployment.
  """
  @impl true
